...
class Enduro(pufferlib.PufferEnv):
    def __init__(self, num_envs=1, frame_skip=1, render_mode="human", report_interval=1, buf=None):
        ...
        self.single_observation_space = gymnasium.spaces.Box(low=0, high=1, shape=(self.num_obs,), dtype=np.float32)
