...
class Policy(torch.nn.Module):
    ...
    def __init__(self, env, input_size=256, hidden_size=256, output_size=256):
        ...
        self.decoders = torch.nn.ModuleList([torch.nn.Linear(hidden_size, n) for n in env.single_action_space.nvec])
    ...
    def encode_observations(self, env_outputs):
        ...
        entity = self.embedding(entity.long().clip(0, 255) + self.entity_offset.to(entity.device))
