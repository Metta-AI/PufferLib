...
def make(name, multiplayer=False, n_rollouts=5, max_simulations=10, min_simulations=None, buf=None):
    """OpenSpiel creation function"""
    ...
    from pufferlib.environments.open_spiel.gymnasium_environment import OpenSpielGymnasiumEnvironment
    from pufferlib.environments.open_spiel.pettingzoo_environment import OpenSpielPettingZooEnvironment
