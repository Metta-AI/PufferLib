...
def test_speed(
    ...
    main_send_pipes, work_recv_pipes = zip(*[Pipe() for _ in range(num_workers)], strict=False)
    work_send_pipes, main_recv_pipes = zip(*[Pipe() for _ in range(num_workers)], strict=False)
